...
CREATE TABLE Estudiante (
  ...
  PRIMARY KEY (estud_cc, estud_id),
    KEY(estud_id), -- para lograr autoincrementar sin error 1075
...
CREATE TABLE Estudiante_posgrado (
  ...
  estudi_posg_id_estudiante INT NOT NULL,
  estudi_posg_prof_cc INT NOT NULL,
  PRIMARY KEY (estudi_posg_cc, estudi_posg_id_estudiante),
    FOREIGN KEY (estudi_posg_cc, estudi_posg_id_estudiante)
    REFERENCES Estudiante (estud_cc , estud_id),
...
CREATE TABLE Evaluacion (
  eval_nota DECIMAL(5,2) NOT NULL,
  eval_porcentaje DECIMAL(5,2) NOT NULL,
  eval_calificacion_minima DECIMAL(5,2) NOT NULL,
  ...
  PRIMARY KEY (eval_ponde_insc_semestre, eval_ponde_insc_estudiante_cc,  eval_ponde_insc_id_programa,eval_ponde_insc_id_asignatura),
