...
CREATE TABLE Historia_Academica (
  ...
  histAcad_cred_excedentes INT NOT NULL DEFAULT 0,
  histAcad_cred_cancelados INT NOT NULL DEFAULT 0,
  histAcad_cred_adicionales INT NOT NULL DEFAULT 0,
  histAcad_cup_creditos INT NOT NULL DEFAULT 0,
  histAcad_cred_disponibles INT NOT NULL DEFAULT 0,
  histAcad_cred_doble_titulacion INT NOT NULL DEFAULT 0,
